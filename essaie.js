...
class helloMap {
    ...
    setup() {
        ...
        // MARKER ville de lyon
        //let marker = L.marker([45.7640, 4.8357]).addTo(mymap);
        ...
        ajaxGet(urlJcDecaux + apiKey, (response) => {
            ...
            stations.forEach((station) => {
                ...
                marker.addEventListener('click', function () {
                    ...
                    //let stationsKey = localStorage.getItem('stations');
                    //let objStations = JSON.stringify(stationsKey);
                    //console.log(objStations);


                    //let objStations = window.objStations;
                ...
                $(document).ready(function () {
                    ...
                    //let $booking_detail = $('#booking_detail');
                    ...
                    canvas.addEventListener('click', function () {
                        ...
                        if (signature == true) {
                            $confirmation_booking.css('display', 'block');
                            $cancel_booking.css('display', 'block');
    ...
    createMap() {
        ...
        tileStreet.addTo(this.mymap);

    }
}


var map = new helloMap();
//map.setup();//JE LANCE LA FUNCTION SETUP DEPUIS LA CLASS MAP
//map.mymap;
